						...
						<div class="inner-settings-wrapper">
							<div id="tp-idle-state-advanced-style" style="float:left; padding-left:20px;">
								...
								<span id="style-sub-filters" class="rs-layer-toolbar-box" style="display:none;border:none;">
									<!-- BLUR START -->
									<i class="rs-mini-layer-icon fa-icon-spinner rs-toolbar-icon tipsy_enabled_top" title="<?php echo "Blur"; ?>"  style="margin-right:8px;font-size:20px;line-height:26px"></i>																	
									<input data-suffix="px" type="text" style="width:105px;" class="input-deepselects rs-inoutanimationfield textbox-caption rs-layer-input-field tipsy_enabled_top" title="<?php echo "Blur"; ?>"  id="blurfilter_idle" name="blurfilter_idle" value="0" data-selects="0||Custom||3||10" data-svalues ="0||5||3||10" data-icons="minus||shuffle||wrench||filter||filter">
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>

									<!-- grayscale START -->
									<i class="rs-mini-layer-icon fa-icon-adjust rs-toolbar-icon tipsy_enabled_top" title="<?php echo "Grayscale"; ?>"  style="margin-right:8px;font-size:20px;line-height:26px"></i>																
									<input data-suffix="%" type="text" style="width:105px;" class="input-deepselects rs-inoutanimationfield textbox-caption rs-layer-input-field tipsy_enabled_top" title="<?php echo "Grayscale"; ?>"  id="grayscalefilter_idle" name="grayscalefilter_idle" value="0"  data-selects="0||Custom||25%||100%" data-svalues ="0||50||25||100" data-icons="minus||wrench||filter||filter">
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>

									<!-- BLEND MODE -->
									<i class="rs-mini-layer-icon fa-icon-star-half-empty rs-toolbar-icon tipsy_enabled_top" title="<?php echo "Blend Mode (Not available for IE)"; ?>" style="margin-right:10px"></i>
									<select class="rs-staticcustomstylechange rs-layer-input-field  tipsy_enabled_top" title="<?php echo "Blend Mode (Not available for IE)"; ?>" style="width:100px;cursor:pointer" id="layer_blend_mode" name="layer_blend_mode">
										<option value="normal"><?php echo 'normal'; ?></option>
										<option value="multiply"><?php echo 'multiply'; ?></option>
										<option value="screen"><?php echo 'screen'; ?></option>
										<option value="overlay"><?php echo 'overlay'; ?></option>
										<option value="darken"><?php echo 'darken'; ?></option>
										<option value="lighten"><?php echo 'lighten'; ?></option>
										<option value="color-dodge"><?php echo 'color-dodge'; ?></option>
										<option value="color-burn"><?php echo 'color-burn'; ?></option>
										<option value="hard-light"><?php echo 'hard-light'; ?></option>
										<option value="soft-light"><?php echo 'soft-light'; ?></option>
										<option value="difference"><?php echo 'difference'; ?></option>
										<option value="exclusion"><?php echo 'exclusion'; ?></option>
										<option value="hue"><?php echo 'hue'; ?></option>
										<option value="saturation"><?php echo 'saturation'; ?></option>
										<option value="color"><?php echo 'color'; ?></option>
										<option value="luminosity"><?php echo 'luminosity'; ?></option>									
									</select>
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>
								</span>
							...
							<div id="tp-hover-state-advanced-style" style="float:left;display:none; padding-left:20px;">
								...
								<span id="hover-sub-filters" class="rs-layer-toolbar-box" style="display:none;border:none;">
									<!-- BLUR START -->
									<i class="rs-mini-layer-icon fa-icon-spinner rs-toolbar-icon tipsy_enabled_top" title="<?php echo "Blur"; ?>"  style="margin-right:8px;font-size:20px;line-height:26px"></i>																	
									<input data-suffix="px" type="text" style="width:105px;" class="input-deepselects rs-inoutanimationfield textbox-caption rs-layer-input-field tipsy_enabled_top" title="<?php echo "Blur"; ?>"  id="blurfilter_hover" name="blurfilter_hover" value="0" data-selects="0||Custom||3||10" data-svalues ="0||5||3||10" data-icons="minus||shuffle||wrench||filter||filter">
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>

									<!-- grayscale START -->
									<i class="rs-mini-layer-icon fa-icon-adjust rs-toolbar-icon tipsy_enabled_top" title="<?php echo "Grayscale"; ?>"  style="margin-right:8px;font-size:20px;line-height:26px"></i>																
									<input data-suffix="%" type="text" style="width:105px;" class="input-deepselects rs-inoutanimationfield textbox-caption rs-layer-input-field tipsy_enabled_top" title="<?php echo "Grayscale"; ?>"  id="grayscalefilter_hover" name="grayscalefilter_hover" value="0"  data-selects="0||Custom||25%||100%" data-svalues ="0||50||25||100" data-icons="minus||wrench||filter||filter">
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>
